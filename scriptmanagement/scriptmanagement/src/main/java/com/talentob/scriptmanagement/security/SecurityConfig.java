package com.talentob.scriptmanagement.security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.POST, "/api/guion/listar").hasAnyAuthority("ADMIN" , "USER")
                .requestMatchers(HttpMethod.POST, "/api/guion/eliminar/**").hasAnyAuthority("ADMIN" )
                .requestMatchers(HttpMethod.POST, "/api/guion/crear").hasAnyAuthority("ADMIN" )
                .requestMatchers(HttpMethod.POST, "/api/guion/obtener/**").hasAnyAuthority("ADMIN" )
